...
class CMLFormulaOperator extends CMLFormulaElem
{
        ...
        static private function snd(r0:Float, r1:Float) : Float { return @:privateAccess sin.sin[sin.index(r0)]; }
        static private function csd(r0:Float, r1:Float) : Float { return @:privateAccess sin.sin[sin.index(r0)+sin.cos_shift]; }
